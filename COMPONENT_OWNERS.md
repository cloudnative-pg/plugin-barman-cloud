...
`plugin-barman-cloud` is a component of the **Extensibility** subproject of
...
repository through the `plugin-barman-cloud-owners` GitHub team, and are its default
